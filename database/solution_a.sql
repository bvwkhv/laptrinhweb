...
SELECT * 
FROM users
WHERE user_email LIKE '%gmail' AND user_name LIKE '%i%' AND LENGTH(user_name) > 5;
...
SELECT * 
FROM users 
WHERE user_name LIKE '%a%' AND LENGTH(user_name) BETWEEN 5 AND 9 AND user_email LIKE '%i%gmail';
